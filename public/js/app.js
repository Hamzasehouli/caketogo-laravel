...
var _JSON$parse, _document$getElementB, _document3, _document3$getElement;

var cakes = (_JSON$parse = JSON.parse(localStorage.getItem("cakes"))) !== null && _JSON$parse !== void 0 ? _JSON$parse : [];
var quantity = 1;
...
(_document3 = document) === null || _document3 === void 0 ? void 0 : (_document3$getElement = _document3.getElementById("add-to-cart")) === null || _document3$getElement === void 0 ? void 0 : _document3$getElement.addEventListener("click", function (e) {
  ...
  cakes = (_cakes = cakes) === null || _cakes === void 0 ? void 0 : _cakes.filter(function (c) {
    return c.id * 1 !== cake.id * 1;
...
function decrement(e) {
  ...
  var target = btn.nextElementSibling; // let value = Number(target.value);
