...
@section('content')
<x-base-section :id="'reset-password'">
  <x-form-component>
  ...
  @endif
    <div class="mb-6">
      ...
      border-red-500
      @enderror  rounded w-full py-2 px-3  mb-3 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email">
      @error('email')
    ...
    <div class="mb-6">
      ...
      border-red-500
      @enderror  rounded w-full py-2 px-3  mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password_confirmation" placeholder="********">
