  ...
  <x-base-section >
    <x-form-component>
      ...
      <div class="w-full max-w-xs">
        <form action="{{route('add.user')}}" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
         @csrf
    <h1 class="mb-4 font-bold text-yellow-400 text-2xl">Add user</h1>
    @if (session('status'))
    ...
    @endif
      ...
      <div class="mb-4">
        ...
        border-red-500
        @enderror shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" name="role" id="role" >
