<footer id="footer" class="relative z-50 bg-black text-white">
        ...
        <div class="mx-auto container px-4 xl:px-12 2xl:px-4">
            <div class="lg:flex">
                ...
                <div class="w-full lg:w-1/2 flex">
                    <div class="w-full lg:w-1/2 px-6">
                        <ul>
                            <li><a href="javascript:void(0)" class="focus:underline focus:outline-none text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand  ">Privacy policy</a></li>
                            <li class="mt-6"><a class="focus:underline focus:outline-none text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand  " href="javascript:void(0)">Terms of service</a></li>
                        </ul>
                    </div>
                    <div class="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                        <div class="flex items-center mb-6">
                            <a  aria-label="Github" href="javascript:void(0)">
                                <div class="  cursor-pointer hover:text-brand dark:hover:text-brand">
                        ...
                        {{-- <div class="relative w-36">
                            <img id="auto" class="dark:hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-device-laptop" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg3.svg" alt="auto">
                            <img id="auto" class="dark:block hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-device-laptop" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg3dark.svg" alt="auto">
                            <img  id="light" class="dark:hidden hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-brightness-up" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg4.svg" alt="light">
                            <img  id="light" class="dark:block hidden hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-brightness-up" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg4dark.svg" alt="light">
                            <img id="dark" class="dark:hidden hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-moon" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg5.svg" alt="dark">
                            <img id="dark" class="dark:block hidden hidden absolute inset-0 m-auto ml-3 text-gray-700  icon icon-tabler icon-tabler-moon" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_1-svg5dark.svg" alt="dark">
    ...
    <div class="py-5 flex flex-col justify-center items-center">
        ...
        <p tabindex="0" class="focus:outline-none mt-6 text-xs lg:text-sm leading-none ">2022 Caketogo. All Rights Reserved.</p>
    </div>
</footer>