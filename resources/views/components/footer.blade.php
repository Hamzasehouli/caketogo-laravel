<footer id="footer" class="relative z-50 dark:bg-pink-700">
    <div tabindex="0" aria-label="footer" class="focus:outline-none border-t  border-gray-200 dark:border-gray-700 py-16">
    ...
    <div class="py-16 flex flex-col justify-center items-center">
        ...
        <p tabindex="0" class="focus:outline-none mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">2022 Caketogo. All Rights Reserved.</p>
    </div>
</footer>